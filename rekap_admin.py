    ...
    if password == "admin123":
        if os.path.exists(FILE_PATH):
            ...
            for i in range(len(df_show)):
                ...
                with cols[0]:
                    st.write(f"""
                        **{df_show.iloc[i]['Tanggal']}**  
                        • Jam Masuk: **{df_show.iloc[i]['Jam Masuk']}**  
                        • Jam Keluar: **{df_show.iloc[i]['Jam Keluar']}**  
                        • Total Jam Kerja: **{df_show.iloc[i]['Total Jam Kerja']} jam**  
                        • Jam Lembur: **{df_show.iloc[i]['Jam Lembur']} jam**  
                        • Total Lembur: **Rp{int(df_show.iloc[i]['Total Lembur (Rp)']):,}**
                    """.replace(",", "."))
